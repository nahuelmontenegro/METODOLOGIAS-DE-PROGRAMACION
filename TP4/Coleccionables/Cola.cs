...
namespace TP4.Coleccionables
{
    ...
    public class Cola : IColeccionable<IComparableX>, CreateIterator
    {
        private List<IComparableX> cola;
        ...
        //Agrega el comparable recibido por parámetro a la colección
        public void agregar(IComparableX comparable)
        {
            this.push(comparable);
        }
